...
import org.jutils.jprocesses.WindowsProcessesService;
...
public class WindowsProcessesServiceTest {
    ...
    public void testGetList() {
        if (OS.isWindows) {
            List<JProcess> list = srv.getList();
            assertEquals(5, list.size());
            assertTrue(list.contains(JProcess1));
            assertTrue(list.contains(JProcess2));
            assertTrue(list.contains(JProcess3));
            assertTrue(list.contains(JProcess4));
            assertTrue(list.contains(JProcess5));
        }
    }
    ...
    public void testGetListWithName() {
        if (OS.isWindows) {
            ...
            List<JProcess> list = srv.getList("java.exe");
